package com.example.plottests.ui.anychart;
...
public class AnyChartFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_anychart, container, false);

        Toast.makeText(getActivity(), "Anychart plot test", Toast.LENGTH_SHORT).show();
